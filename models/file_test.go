...
var (
	fileDBTypes = map[string]string{`ID`: `INTEGER`, `Path`: `TEXT`, `Name`: `TEXT`, `Format`: `INTEGER`, `Size`: `INTEGER`, `Title`: `TEXT`, `Publisher`: `TEXT`, `PublisherID`: `INTEGER`, `Creator`: `TEXT`, `Subject`: `TEXT`, `Language`: `TEXT`, `Description`: `TEXT`, `DateCreated`: `DATETIME`, `DateModified`: `DATETIME`, `DateAccessed`: `DATETIME`, `Rating`: `INTEGER`, `Hash`: `VARCHAR(64)`, `AppleBooks`: `BOOLEAN`, `Series`: `TEXT`, `SeriesID`: `INTEGER`, `Pages`: `INTEGER`, `Isbn`: `TEXT`, `DatePublished`: `DATETIME`}
	_           = bytes.MinRead
)
